...
class window.DetailInputView extends Backbone.View
  ...
  next: ->
    app.currentEntry.set({
                          status: @statuses.get(parseInt($("select#status option:selected").val())), 
                          category: @categories.get(parseInt($("select#category option:selected").val())), 
                          subcategory: @subCategories.get(parseInt($("select#subcategory option:selected").val())),
                          severity: @severities.get(parseInt($("select#severity option:selected").val())),  
                          certainty: @certainties.get(parseInt($("select#certainty option:selected").val())), 
